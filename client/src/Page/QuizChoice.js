...
const QuizChoice = () => {
  ...
  return (
    <>
{userData!=null &&(<Navbar displayName={userData.displayName} role={userData.userRole} isVerify={userData.isVerify}/>)}    <div className="flex flex-col items-center justify-center h-screen bg-gray-50">
