...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const requestResponse = await axios.post("https://localhost:7227/token", {
        email,
        password
        ...
        <div className="flex w-1/2 h-full bg-[#256289] justify-around text-white items-center text-center flex-col"> 
          ...
          <div className="m-10">          
            <h2 className="text-xl">
              <p>Transformez vos rêves de programmation en réalité.</p> 
              <p>Ensemble, apprenons et créons des projets incroyables.</p>
            </h2>
          </div>
